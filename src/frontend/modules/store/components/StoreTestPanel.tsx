...
interface StoreTestPanelProps {
  isRTL?: boolean;
}

const StoreTestPanel = ({ isRTL = false }: StoreTestPanelProps) => {
  ...
  const unitTests = [
    ...
    {
      file: "AIProductRecommendations.tsx",
      coverage: 54,
      status: "pass",
  ...
  const integrationTests = [
    {
      file: "ProductOrderFlow.test.tsx",
      coverage: 76,
      status: "pass",
      lastRun: "2023-05-24 15:10",
    },
    {
      file: "InventoryUpdateFlow.test.tsx",
      coverage: 63,
      status: "fail",
      lastRun: "2023-05-24 14:55",
    },
    {
      file: "StoreSettingsFlow.test.tsx",
      coverage: 82,
      status: "pass",
