...
interface InboxTestPanelProps {
  isRTL?: boolean;
}

const InboxTestPanel = ({ isRTL = false }: InboxTestPanelProps) => {
  ...
  const unitTests = [
    ...
    {
      file: "ConversationManager.tsx",
      coverage: 73,
      status: "pass",
      lastRun: "2023-05-24 13:45",
    },
    {
      file: "CustomerService.tsx",
      coverage: 65,
      status: "fail",
      lastRun: "2023-05-24 12:30",
    },
    {
      file: "InboxSettings.tsx",
      coverage: 87,
      status: "pass",
      lastRun: "2023-05-24 11:15",
    },
    {
      file: "AIResponseGenerator.tsx",
      coverage: 58,
      status: "pass",
  ...
  const integrationTests = [
    {
      file: "MessageRouting.test.tsx",
      coverage: 75,
      status: "pass",
      lastRun: "2023-05-24 15:10",
    },
    {
      file: "NotificationSystem.test.tsx",
      coverage: 67,
      status: "fail",
      lastRun: "2023-05-24 14:55",
    },
    {
      file: "AgentAssignment.test.tsx",
      coverage: 78,
      status: "pass",
    ...
    <div className="container mx-auto p-6 bg-background">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold">
          {isRTL ? "لوحة اختبار صندوق الوارد" : "Inbox Test Panel"}
        </h1>
        <Button>
