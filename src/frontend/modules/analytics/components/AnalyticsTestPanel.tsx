...
import { Play, FileCode, CheckCircle, XCircle, BarChart } from "lucide-react";

interface AnalyticsTestPanelProps {
  isRTL?: boolean;
}

const AnalyticsTestPanel = ({ isRTL = false }: AnalyticsTestPanelProps) => {
  ...
  const unitTests = [
    ...
    {
      file: "SalesTrends.tsx",
      coverage: 65,
      status: "pass",
      lastRun: "2023-05-24 13:45",
    },
    {
      file: "UserBehavior.tsx",
      coverage: 58,
      status: "fail",
      lastRun: "2023-05-24 12:30",
    },
    {
      file: "MarketingROI.tsx",
      coverage: 81,
      status: "pass",
  ...
  const integrationTests = [
    {
      file: "AnalyticsDataFlow.test.tsx",
      coverage: 66,
      status: "pass",
      lastRun: "2023-05-24 15:10",
    },
    {
      file: "ChartRendering.test.tsx",
      coverage: 53,
      status: "fail",
      lastRun: "2023-05-24 14:55",
    },
    {
      file: "DataFiltering.test.tsx",
      coverage: 72,
      status: "pass",
    ...
    <div className="container mx-auto p-6 bg-background">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold">
          {isRTL ? "لوحة اختبار التحليلات" : "Analytics Test Panel"}
        </h1>
        <Button>
