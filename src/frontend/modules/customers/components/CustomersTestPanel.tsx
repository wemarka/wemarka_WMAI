...
import { Play, FileCode, CheckCircle, XCircle, Users } from "lucide-react";

interface CustomersTestPanelProps {
  isRTL?: boolean;
}

const CustomersTestPanel = ({ isRTL = false }: CustomersTestPanelProps) => {
  ...
  const unitTests = [
    ...
    {
      file: "AICustomerInsights.tsx",
      coverage: 62,
      status: "fail",
      lastRun: "2023-05-24 12:30",
    },
    {
      file: "CustomersDashboard.tsx",
      coverage: 81,
      status: "pass",
      lastRun: "2023-05-24 11:15",
    },
    {
      file: "CustomerSegmentation.tsx",
      coverage: 70,
      status: "pass",
  ...
  const integrationTests = [
    {
      file: "CustomerDataFlow.test.tsx",
      coverage: 76,
      status: "pass",
      lastRun: "2023-05-24 15:10",
    },
    {
      file: "CustomerFiltering.test.tsx",
      coverage: 63,
      status: "fail",
      lastRun: "2023-05-24 14:55",
    },
    {
      file: "CustomerProfileFlow.test.tsx",
      coverage: 82,
      status: "pass",
    ...
    <div className="container mx-auto p-6 bg-background">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold">
          {isRTL ? "لوحة اختبار العملاء" : "Customers Test Panel"}
        </h1>
        <Button>
...
export default CustomersTestPanel;
