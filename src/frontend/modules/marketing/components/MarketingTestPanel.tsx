...
const MarketingTestPanel = ({ isRTL = false }: MarketingTestPanelProps) => {
  ...
  const unitTests = [
    ...
    {
      file: "ContentCreator.tsx",
      coverage: 68,
      status: "pass",
      lastRun: "2023-05-24 13:45",
    },
    {
      file: "PerformanceTracker.tsx",
      coverage: 72,
      status: "fail",
      lastRun: "2023-05-24 12:30",
    },
    {
      file: "MarketingSettings.tsx",
      coverage: 85,
      status: "pass",
  ...
  const integrationTests = [
    {
      file: "CampaignWorkflow.test.tsx",
      coverage: 74,
      status: "pass",
      lastRun: "2023-05-24 15:10",
    },
    {
      file: "ContentPublishFlow.test.tsx",
      coverage: 65,
      status: "fail",
      lastRun: "2023-05-24 14:55",
    },
    {
      file: "AnalyticsIntegration.test.tsx",
      coverage: 77,
      status: "pass",
...
export default MarketingTestPanel;
